...
public class TaskDataBaseHandler extends SQLiteOpenHelper {
    ...
    private static final String SQL_CREATE_ENTRIES = "CREATE TABLE " + TasksDataContract.TasksEntry.TABLE_NAME + " (" + TasksDataContract.TasksEntry.KEY_STARTTIME + " TEXT," + TasksDataContract.TasksEntry.KEY_ENDTIME + " TEXT," + TasksDataContract.TasksEntry.KEY_TASK + " TEXT)";
